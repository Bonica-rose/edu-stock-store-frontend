...
import { fetchInventoryAIPrediction } from "@/features/ai/redux/aiThunks";
import { clearAIInventory } from "@/features/ai/redux/aiSlice";
import AIPredictionCard from "@/features/ai/components/AIPredictionCard";
import { ROLES } from "@/shared/constants/roles";

const AI_ROLES = new Set([
    ROLES.SUPER_ADMIN, ROLES.BRANCH_ADMIN, ROLES.INVENTORY_STAFF, 
]);
...
export default function ViewInventoryPage() {
    ...
    const {
        ...
        loading: aiLoading,
        error: aiError,
    } = useSelector((state) => state.ai.inventory);
    ...
    useEffect(() => {
        ...
        dispatch(clearAIInventory());
    }, [dispatch, id]);

    useEffect(() => {
        if (id && canUseAI) {
            dispatch(fetchInventoryAIPrediction(id));
        }
    }, [dispatch, id, canUseAI]);
                    ...
                    {aiLoading && !aiData && (
                        <Card className="rounded-sm">
                            <CardContent className="py-8 text-center text-sm text-muted-foreground">
                                Generating AI inventory prediction...
                            </CardContent>
                        </Card>
                    )}
