...
export default function StockTransferForm({
    ...
    useEffect(() => {
        ...
        (item) =>
            item.itemName === selectedInventory.itemName &&
    ...
    const submitForm = async (data) => {
        ...
        // Destination inventory must exist
        if (!destinationInventory) {
        setError("toBranch", {
            type: "manual",
            message:
            "This inventory item does not exist in the destination branch.",
        });
        ...
        <CardContent>
          ...
          >
            ...
            {/* <Field>
                    ...
                    {errors.toBranch && (
                        <FieldError>{errors.toBranch.message}</FieldError>
                    )}
                    </Field> */}
                ...
                {destinationInventory ? (
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {destinationInventory.sku} -{" "}
                      {destinationInventory.itemName}
                    </p>
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      This item does not exist in the selected destination
                      branch.
                    </p>
                  </div>
                )}
            ...
            <div className="flex justify-start gap-3">
              <Button
                type="submit"
                disabled={
                  loading || !selectedInventory || !destinationInventory
                }
              >
                {loading ? (
                  <>
