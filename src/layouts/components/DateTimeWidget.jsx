...
export default function DateTimeWidget({ timeZone, className = "" }) {
    ...
    <div className={`flex h-15 w-52 items-center text-zinc-900 ${className}`}>
      <div className="min-w-0">
        ...
        <div className="flex items-center gap-2">
          <Clock3 className="h-4 w-4 shrink-0 text-sky-600 dark:text-sky-400" />
          <span className="text-md font-semibold tracking-tight tabular-nums dark:text-white">
            {time}
          </span>
        </div>
